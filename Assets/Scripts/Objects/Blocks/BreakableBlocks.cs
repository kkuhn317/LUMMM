...
public class BreakableBlocks : MonoBehaviour
{
    ...
    public void Break()
    {
        ...
        if (BlockPiece != null) {
            ...
            BlockPiece1.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(-4, 16);
            ...
            BlockPiece2.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(4, 16);
            ...
            BlockPiece3.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(-4, 10);
            ...
            BlockPiece4.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(4, 10);
