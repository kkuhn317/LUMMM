...
public class BlockItem : MonoBehaviour
{
    ...
    private IEnumerator Animate()
    {
        ...
        rigidbody.isKinematic = true; //The physics engine won't simulate physics
        ...
        if (audioSource != null && powerUpAppears != null)
        {
        ...
        rigidbody.isKinematic = false; //The physics engine will simulate physics
