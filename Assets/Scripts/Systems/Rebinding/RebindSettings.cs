...
public class RebindSettings : MonoBehaviour, IPauseToggleGate
{
    ...
    public void EnableTogglePause() => CanTogglePause = true;
    public void DisableTogglePause() => CanTogglePause = false;
    ...
    void Start()
    {
        ...
        buttonPressedOpacitySlider.onValueChanged.AddListener(UpdateButtonPressedOpacity);
        buttonUnpressedOpacitySlider.onValueChanged.AddListener(UpdateButtonUnpressedOpacity);
